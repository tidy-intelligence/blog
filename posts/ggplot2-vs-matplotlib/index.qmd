   ...
   <h2>Related articles</h2>
    <div class="articles-container">
      <a href="../ggplot2-vs-seaborn/index.html" class="article">
        ...
        <a href="../interactive-data-visualization-with-python/index.html" class="article">
        <div class="quarto-grid-item">
            <img src="../interactive-data-visualization-with-python/thumbnail.png">
            <div class="card-body post-contents">
                <h5 class="no-anchor card-title listing-title">Interactive Data Visualization with R</h5>
                <div class="card-text listing-description">A comparison of popular dynamic visualization libraries for R</div>
            </div>
        </div>
        </a>
