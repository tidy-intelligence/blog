...
### Python
```{python}
sakura_first_bloom_dates = pd.read_csv("https://raw.githubusercontent.com/christophscheuch/data-viz-japan/main/data/sakura_first_bloom_dates.csv")
sakura_full_bloom_dates = pd.read_csv("https://raw.githubusercontent.com/christophscheuch/data-viz-japan/main/data/sakura_full_bloom_dates.csv")
...
library(arrow)
write_parquet(sakura_data, "sakura_data.parquet")
```

```{python}
sakura_data = pd.read_parquet("sakura_data.parquet")
```
...
#| message: false
#| warning: false
(ggplot(sakura_data, aes(x='year', y='time_to_full_bloom'))
