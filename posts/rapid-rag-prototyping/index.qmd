...
::: {.callout-note} 
I came across the promising [`ragner`](https://github.com/tidyverse/ragnar) package a few weeks after I wrote this blog post. While it is still actively being developed, it already offers a streamlined alternative to the application described below.
:::
